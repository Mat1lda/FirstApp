package com.quanvm.meplanner.timetable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Sun1.setText(snapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Monday1").getValue(String.class));
                Sun2.setText(snapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Monday2").getValue(String.class));
                Sun3.setText(snapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Monday3").getValue(String.class));
                Sun4.setText(snapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Monday4").getValue(String.class));
                Sun5.setText(snapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Monday5").getValue(String.class));
                Sun6.setText(snapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Monday6").getValue(String.class));
                Sun7.setText(snapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Monday7").getValue(String.class));
    ...
    public void show(TextView textView,String dayname){
        ...
        delete_subject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseStudents.child(user.getUid()).child(dayname).removeValue();
                textView.setText("");
                dialog.dismiss();
            }
        });
